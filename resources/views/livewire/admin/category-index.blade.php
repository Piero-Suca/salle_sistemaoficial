                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="name" placeholder="Ingrese el nombre" autocomplete="off" required>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="description">Descripción</label>
                            <input type="text" class="form-control" name="description" placeholder="Ingrese una descrición" autocomplete="off" required>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="modal fade" id="editModal{{ $categorias->id }}" tabindex="-1" role="dialog" aria-labelledby="editModal{{ $categorias->id }}Label" aria-hidden="true">
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                ...
                                <form action="{{ route('admin.categoria.update', $categorias->id) }}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    @method('PUT')
                                    <div class="modal-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control to-uppercase" name="name" id="name{{ $categorias->id}}" autocomplete="off" value="{{ $categorias->name}}">
                                        </div>
                                        <div class="form-group">
                                            <label for="description{{ $categorias->id }}">Descripción</label>
                                            <input type="text" class="form-control to-uppercase" name="description" id="description{{ $categorias->id}}" autocomplete="off" value="{{ $categorias->description}}">
                                        </div>
